  ...
  static List<Message> list() {
    const data = <Message>[
      Message(
          ...
          name: 'Harison Max',
          time: '5.10 pm'),
      Message(id: 2, text: 'hello', type: 'receiver', time: '5.10 pm'),
      Message(
          id: 3,
          ...
          name: 'Harison Max',
          time: '5.20 pm'),
      Message(id: 4, text: 'Thanks', type: 'receiver', time: '5.20 pm'),
      Message(
          id: 5,
      ...
      Message(
          ...
          name: 'Harison Max',
          time: '5.45 pm'),
      Message(id: 8, text: 'Sure', type: 'receiver', time: '5.47 pm'),
    ];
    return data;
  }
}
